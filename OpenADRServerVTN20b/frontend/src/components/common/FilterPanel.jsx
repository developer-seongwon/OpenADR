  ...
  render() {
    ...
    return (
      <span>
        ...
        {(hasFilter && hasFilter.marketContext) ? <span><IconButton
        ...
        {(hasFilter && hasFilter.group) ? <span><IconButton
          className={ classes.iconButton }
          aria-label="group"
        ...
        {(hasFilter && hasFilter.venStatus) ? <span><IconButton
          className={ classes.iconButton }
          aria-label="group"
        ...
        {(hasFilter && hasFilter.ven) ? <span><IconButton
          className={ classes.iconButton }
          aria-label="ven"
        ...
        {(hasFilter && hasFilter.eventStatus) ? <span><IconButton
          className={ classes.iconButton }
