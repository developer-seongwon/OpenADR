...
psql -v ON_ERROR_STOP=1 --username "oadr-openfire" --dbname "oadr-openfire" <<-EOSQL
...
psql -v ON_ERROR_STOP=1 --username "oadr-openfire" --dbname "oadr-openfire" <<-EOSQL
	...
	INSERT INTO ofproperty(name,propvalue) VALUES('xmpp.socket.ssl.client.truststore','/usr/share/openfire/resources/security/truststore');
	...
	INSERT INTO ofproperty(name,propvalue) VALUES('xmpp.bosh.ssl.client.truststore','/usr/share/openfire/resources/security/truststore');
